...
import { fetchDATA, requests } from "@hooks/useFetchData";
...
const Friend: React.FC<types> = (props) => {
  ...
  const goToChat = () => {
    ...
    } else Router.push("/chat?login=" + props.login);
  };
  ...
  return (
    <div className={classes.friend}>
      <div className={classes.Avatar_name}>
        ...
        <div className={classes.friendName} onClick={profileFriendHandler}>
      ...
      <div className={classes.optionFriend}>
        ...
        <div
          ...
          ref={wrapperRef}
        >
          <BiDotsVerticalRounded size="20px" color="white" />
          {optionTaggle && (
            <OptionMenu
              FirstBtn="Remove Friend"
