...
export const ChannelMember: React.FC<Props> = ({
  ...
  const kickMemberClickHandler = async () => {
    if (convId) {
      if (await fetchKickMember({ member: member.login }, convId)) {
        setIsSuccess(true);
      }
    }
  };
    ...
    <>
      ...
      <div className={Styles.ChannelMemberContainer}>
        <div className={Styles.ChannelMemberProfile}>
          ...
          />
          {loggedInUsr === member.login ? "You" : member.login}
        </div>
              ...
              >
                {role === "Admins" ? (
                  ...
                  <>
                    ...
                    <SettingOption
                      name="Kick member"
                      optionClickHandler={kickMemberClickHandler}
                    />
                  </>
                ) : (
                  <SettingOption
