...
const Setting: React.FC = () => {
  ...
  const sub = (e: any) => {
    e.preventDefault();
    if (inputValue.length === 6) toggleHandler();
  };
  return (
    <>
      {isValid && (
        ...
        >
          ...
          >
            ...
            <div className={classes.pages}>
              {QRcode === "#" && (
                <FirstPage isOn={isOn} toggleSwitch={toggleSwitch} />
              )}
              <motion.div
                defaultValue={"closed"}
                animate={
                  QRcode !== "#" ? "open" : QRcode === "#" ? "hide" : "closed"
                }
                variants={variants}
            ...
            <div
              ...
              onClick={
                (QRcode === "#" && !isOn && handlerDisable) || toggleHandler
              }
            >
